...
public class ConvidadoRepository {
    ...
    public boolean save(Convidado convidado) {
        try {
            ...
            if(convidado.getId() == 0){
                ...
                String[] whereArgs = { Integer.toString(convidado.getId()) };
               db.update(DataBaseConstants.CONVIDADO.TABLE_NAME,values,"ID=?",whereArgs );
            }
    ...
    public Convidado findById(String sql) {
        try {
